                    ...
                    <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col lg:flex-row gap-3 w-full mb-3">
                            <div class="w-full">
                                ...
                                <x-text-input id="full_name" class="block mt-1 w-full" type="text" name="full_name"
                                    :value="old('full_name')" required autofocus autocomplete="off" />
                        ...
                        <div class="flex flex-col lg:flex-row gap-3 w-full mb-3">
                            <div class="w-full">
                                ...
                                <x-text-input id="date_of_birth" class="block mt-1 w-full" type="date"
                                    name="date_of_birth" :value="old('date_of_birth')" required autofocus autocomplete="off" />
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="position" class="block mt-1 w-full" type="text" name="position"
                                    :value="old('position')" required autocomplete="off" />
                        ...
                        <div class="flex flex-col lg:flex-row gap-3 w-full mb-3">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="employee_id" class="block mt-1 w-full" type="text"
                                    name="employee_id" :value="old('employee_id')" autocomplete="off" />
                        ...
                        <div class="flex flex-col lg:flex-row gap-3 w-full mb-3">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="government_id_number" class="block mt-1 w-full" type="text"
                                    name="government_id_number" :value="old('government_id_number')" autocomplete="off" />
                        ...
                        <div class="flex flex-col lg:flex-row gap-3 w-full">
                            <div class="w-full">
                                ...
                                <x-textarea id="notes" name="notes" rows="3" :value="old('notes')" />
